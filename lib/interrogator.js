...
Interrogator.prototype.updateObject = function(obj, questions, callback) {
    ...
    questions.forEach(function(question) {
        ...
        tasks.push(function(callback) {
            self.question.call(self, question, function(err, result) {
...
Interrogator.prototype.question = function(question, callback) {
    ...
    ["descriptionFormatter", "optionsFormatter", "optionLineFormatter", "errorFormatter"].forEach(function(i) {
        question[i] = question[i] || self[i];
        question[i].bind(self);
    });
    ...
    if(question.optionsFetcher) {
        return question.optionsFetcher(function(err, options) {
            ...
            return self.question.call(self, question, callback);
        });
    }
